...
export default function App() {
  ...
  const [tempData, setTempData] = useState({ history: [], current: 0, heartRate: 0, activity: 'Normal', uptime: 99.8, name: '' })
  const [aiResult, setAiResult] = useState(null)
  const [aiStatus, setAiStatus] = useState('idle') // idle | running | completed
